...
class MemN2N(object):
    ...
    def __init__(self,
        ...
        # print("embedding_size:", self._embedding_size)
    ...
    def _build_params(self):
        ...
        with tf.variable_scope(self._name):
            ...
            # TODO delete
            # self.C[-1] will act as the answer prediction weight matrix, so we don't need W
            # self.W = tf.Variable(self._initializer([self._embedding_size, self._vocab_size]), name = "W")
    ...
    def _build_model(self):
        ...
        with tf.variable_scope(self._name):
            ...
            with tf.variable_scope('hop_{}'.format(self._hops)):
                # TODO delete
                # self._answer = tf.matmul(u, tf.transpose(self.C[-1]))
